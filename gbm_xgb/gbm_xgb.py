...
class xgb_model:
    def __init__(self, train_data, val_data, label_name,  params, is_kfold=False):
        self.train_data = train_data
        self.val_data = val_data
        self.label_name = label_name
        self.compare_val_data = self.val_data.copy()
        self.params = params
        ...
        # 验证集的val_feature, val_label
        self.val_y = self.val_data[self.label_name].values
        self.val_data.drop(self.label_name, axis=1, inplace=True)
        self.val_data = self.val_data.values
...
class gbm_model:
    def __init__(self, train_data, val_data, label_name, val_need_columns,  params, is_kfold=False):
        self.train_data = train_data
        self.val_data = val_data
